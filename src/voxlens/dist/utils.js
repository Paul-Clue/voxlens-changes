...
exports.verbalise = exports.validate = exports.sanitizeVoiceText = exports.logKeyPresses = exports.logCommand = exports.isCommandDuplicate = exports.getSettings = exports.getModifier = exports.getKeyFromEvent = exports.getKeyBinds = exports.getInstructionsText = exports.getDefaults = exports.getArrayFromObject = exports.generateInstructions = exports.formatOptions = exports[
  "default"
] = exports.createTemporaryElement = exports.addThousandsSeparators = exports.addFeedbackToResponse = void 0;
...
var getModifier = function getModifier(settings) {
  ...
  var modifier = settings.multipleModifiers
...
var getInstructionsText = function getInstructionsText(
  triggers,
  title,
  settings
) {
  ...
  var mappedTriggers = _get__("getMappedTriggers")(
    triggers,
    modifier,
    settings
  );
  ...
  return "Graph with title: "
    .concat(title, ". To interact with the graph, press ")
    .concat(
      mappedTriggers.mainKey,
    ...
    .concat(mappedTriggers.summaryKey, ". To hear the audio graph, press ")
    .concat(mappedTriggers.trendKey, ". To repeat these instructions, press ")
    .concat(
      mappedTriggers.instructionsKey,
...
var generateInstructions = function generateInstructions(
  viewportElement,
  triggers,
  title,
  settings
  ...
  for (
    var _i = 0, _Array$from = Array.from(viewportElement.children);
...
var isCommandDuplicate = function isCommandDuplicate(
  lastIssuedCommand,
  activatedCommands
) {
  var timeNow = Date.now();
  var isCommandSameAsLast =
...
var sanitizeVoiceText = function sanitizeVoiceText(voiceText) {
  ...
  voiceText = voiceText
    ...
    .filter(function(v) {
      return (
        (Number.isInteger(parseInt(_get__("wordsToNumbers")(v))) ||
          v.trim().length > 2) &&
        !_get__("stopWords").includes(v)
      );
    })
    .join(" ")
    .trim();
